...
Hi! I'm **Aqsa Kanwal**, a **Section Leader for Stanford University's Code in Place 2026** program.

I am a **Food Science & Technology** Student passionate about teaching, mentoring, and helping beginners learn programming in an engaging and supportive environment.
...
| Week   | Topic                  | Folder                          |
| ------ | ---------------------- | ------------------------------- |
| Week 1 | Hospital Karel         | `Week_1_Hospital_Karel`         |
| Week 2 | Art of Karel           | `Week_2_Art_of_Karel`           |
| Week 3 | Intro to Python        | `Week_3_Intro_to_Python`        |
| Week 4 | Python Control Flow    | `Week_4_Python_Control_Flow`    |
| Week 5 | Graphics               | `Week_5_Graphics`               |
| Week 6 | Lists and Dictionaries | `Week_6_Lists_and_Dictionaries` |
